...
// A generation's assistant message id is a millisecond timestamp (optionally
// suffixed with "r" for a retried/regenerated answer). Used to order
// generations most-recent-first across every merged document-set key, the
// same way Source Trace orders them.
